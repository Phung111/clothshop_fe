      ...
      <div className="flex flex-col gap-5">
        <div className="flex flex-col items-end gap-5">
          <div className="flex items-center gap-5">
            ...
            <p className="w-[150px] text-right text-sm">₫487.000</p>
          </div>
          <div className="flex items-center gap-5">
            <p className="w-[150px] text-sm text-black/50">Shipping Total:</p>
            <p className="w-[150px] text-right text-sm">₫63.300</p>
          </div>
          <div className="flex items-center gap-5">
            <p className="w-[150px] text-sm text-black/50">Voucher Total:</p>
            <p className="w-[150px] text-right text-sm">₫50.000</p>
          </div>
          <div className="flex items-center gap-5">
            <p className="w-[150px] text-sm text-black/50">Total Payment:</p>
            <p className="w-[150px] text-right text-[28px] text-primary">₫600.300</p>
          </div>
        </div>
        <div className="line" />
